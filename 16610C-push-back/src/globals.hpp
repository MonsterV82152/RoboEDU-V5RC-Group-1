...
inline pros::Motor frontLeft(1);
inline pros::Motor middleLeft(2); // Set reversed to true if needed
inline pros::Motor backLeft(3);
inline pros::Motor frontRight(4);
inline pros::Motor middleRight(5);
inline pros::Motor backRight(6);
