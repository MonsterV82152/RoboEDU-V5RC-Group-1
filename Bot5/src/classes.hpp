...
inline ColourSorter colourSorter(&hook, &intake, &Manipulator::colourSensor, &Manipulator::hookDistanceSensor, 20);
...
inline LadyBrown ladyBrown(&LadyBrownConfigs::motor, &LadyBrownConfigs::rotationSensor, &LadyBrownConfigs::PID, &hook, &colourSorter);
inline Controls controls(&intake, &hook, &ladyBrown, &colourSorter, &mogoClamp, &leftWing, &master);
