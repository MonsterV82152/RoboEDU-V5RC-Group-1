...
inline bool climbControls = false;
...
namespace Pneumatics {
    inline pros::ADIDigitalOut mogoClampPiston('B'); // BOT 1 - 'A', BOT 2 - 'H'
    inline pros::ADIDigitalOut ladyBrownPiston('A'); // BOT 1 - 'B', BOT 2 - 'E'
    inline pros::ADIDigitalOut PTOPiston('C'); // BOT 1 - 'D', BOT 2 - 'F'
    inline pros::ADIDigitalOut doinkerPiston('E'); // BOT 1 - 'C', BOT 2 - 'C'
}


namespace DriveTrain {
    inline pros::MotorGroup left({-7, -9, -10}); // BOT 1 - {-8, -9, -10}, BOT 2 - {-18, -19, -20}
    inline pros::MotorGroup right({2, 3, 11}); // BOT 1 - {1, 2, 3}, BOT 2 - {11, 12, 13}
    inline pros::Distance frontDS(99);
    inline pros::Distance backDS(99);
    inline pros::Distance rightDS(5); // BOT 1 - 12
    inline pros::Distance leftDS(20); // BOT 1 - 18
}
...
namespace Manipulator {
    inline pros::Motor intakeMotor(8); // BOT 1 - 21, BOT 2 - 9
    inline pros::Motor rollerMotor(-19);
    inline pros::Optical colourSensor(6);
    inline pros::Distance distanceSensor(17);
}
...
namespace LadyBrownConfigs {
    ...
    inline double LBOFFSET = -345;
    inline double POT_TICK_2_DEGREE = 10.2;
    inline double LB_HORIZONTAL = 21;

    inline pros::ADIAnalogIn potentiometer('D'); // BOT 1 - 'E', BOT 2 - 'D'
...
namespace OdometryConfigs {
    ...
    inline pros::Rotation vertical_TWL(-12);
    ...
    inline lemlib::TrackingWheel LEMLIB_vertical_TWL(&vertical_TWL, 2, 0.22);
